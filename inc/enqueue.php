...
if ( ! function_exists( 'paddle_theme_scripts' ) ) :
	function paddle_theme_scripts() {
		...
		// Offcanvas
		wp_enqueue_script( 'paddle-theme-navigation-scripts', get_template_directory_uri() . '/js/navigation.min.js',array(), filemtime( get_template_directory( __FILE__ ) . '/js/navigation.min.js' ), true );
